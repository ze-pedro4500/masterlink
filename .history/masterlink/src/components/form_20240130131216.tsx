...
const DynamicForm: React.FC = () => {
  ...
  const [fieldValue, setFieldValue] = useState<string>(''); // Initialize fieldValue state
              ...
              {field.type === 'card' ? (
                ...
                <>
                  <input
                    ...
                    className={`appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline ${field.type === 'password' ? 'type-password' : ''}`}
