...
const DynamicForm: React.FC = () => {
        ...
        metadata?.fields.map(async (field) => {
          return (
            <div className="mb-5" key={field.id}>
              <label className="text-center block mb-2 text-sm font-medium text-gray-900 dark:text-white">{field.name}</label>
              {field.type === 'card' ? (
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form className="max-w-sm mx-auto border border-black p-4" onSubmit={handleSubmit}>
