...
const DynamicForm: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form className="md:max-w-sm md:mx-auto border border-black p-4 rounded-xl md:min-w-96 w-5/6" onSubmit={handleSubmit}>
        <h2 className='text-2xl font-bold text-center mb-4'>{metadata?.title}</h2>
        {formFields}
        <div className="flex items-center justify-center">
  <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">
    Submit
  </button>
</div>      </form>
    </div>
